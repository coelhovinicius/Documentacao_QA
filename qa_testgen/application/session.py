...
class SessionState:
    DEFAULTS = {
        ...
        'doc_text': '',
        'project_name': '',
        'project_name_suggestion': None,
        'report_wi_project_name': '',
        'report_wi_project_name_suggestion': None,
        'manual_nome_suggestion': None,
        'mindmap_wi_nome_raiz': '',
        'mindmap_wi_nome_raiz_suggestion': None,
        'ambiente_testes': '',
        'uploaded_files': [],
        'questions': [],
        'user_answers': {},
        ...
        'bug_board_items': [],
        'bug_test_cases': [],
        'bug_ultimo_criado': None,
        'bug_ultimo_criado_livre': None,
        'manual_query_available': [],
        'query_wigen_available_queries': [],
        'query_wigen_board_items': [],
        'query_wigen_selected_ids': [],
        ...
        'show_bug_page': False,
        'show_bug_confirm_modal': False,
        'scroll_to_top_pending': False,
        'mindmap_board_items': [],
        'mindmap_wi_hierarquia': {},
        'mindmap_wi_raiz_nome': '',
        'manual_uploaded_files': [],
        'manual_board_items': [],
        'manual_collected_images': [],
        'manual_nome': '',
        'manual_generated': None,
        'manual_passo_images': {},
