...
class UserInterface:
    ...
    def step_2(self):
        ...
        if st.session_state.current_action == "generate_matrix":
            with st.spinner("Estruturando Matriz de Rastreabilidade… Aguarde..."):
                try:
    ...
    def step_3(self):
        ...
        if st.session_state.current_action == "generate_cases":
            with st.spinner("Gerando Casos de Teste… Aguarde..."):
                try:
    ...
    def step_6(self):
        ...
        with st.spinner("Gerando binários do PDF… Aguarde..."):
